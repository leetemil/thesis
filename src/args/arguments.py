...
def get_vae_args():
    ...
    parser.add_argument("-vr", "--val_ratio", type = float, default = 0.2, help = "What fraction of data to use for validation. Set to 0 to disable validation (patience will then work on training loss).")
