...
def basic_args(parser):
    ...
    parser.add_argument("--L2", type = float, default = 0, help = "L2 regularization added as weight decay to Adam optimizer.")
...
def get_wavenet_args():
    ...
    parser.add_argument("--dropout", type = float, default = 0.5, help = "Rate of dropout to apply between layers.")
